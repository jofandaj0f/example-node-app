...
MCS.formatHtml = function(a,id){
  ...
  $(id).empty();
  a.forEach(e => {
    $(id).append(`<li class="list-group-item"><ul class="list-group list-group-flush"><li class="list-group-item list-group-item-dark"><h4>Tracking ID</h4><input type="button" class="btn btn-outline-warning" value="${e.trackingID}" onclick="copyandpaste(this)"></li><li class="list-group-item list-group-item-light"><h4>Bandwidth</h4><input type="button" class="btn btn-outline-warning" value="${e.bandwidth}" onclick="copyandpaste(this)"></li><li class="list-group-item list-group-item-light"><h4>Multicast Destination IP</h4><input type="button" class="btn btn-outline-warning" value="${e.destinationIP}" onclick="copyandpaste(this)"></li><li class="list-group-item list-group-item-light"><h4>Incoming Interface ID</h4><input type="button" class="btn btn-outline-warning" value="${e.senderId}-${e.senderPort}" onclick="copyandpaste(this)"></li></ul></li>`); 
